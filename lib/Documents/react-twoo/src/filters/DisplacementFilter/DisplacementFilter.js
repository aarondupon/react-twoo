...
var DisplacementFilter = /*#__PURE__*/function (_PIXI$Filter) {
  _rollupPluginBabelHelpers.inherits(DisplacementFilter, _PIXI$Filter);

  var _super = _rollupPluginBabelHelpers.createSuper(DisplacementFilter);
  ...
  function DisplacementFilter(resolution) {
    ...
    _rollupPluginBabelHelpers.classCallCheck(this, DisplacementFilter);
  ...
  _rollupPluginBabelHelpers.createClass(DisplacementFilter, [{
    key: "apply",
