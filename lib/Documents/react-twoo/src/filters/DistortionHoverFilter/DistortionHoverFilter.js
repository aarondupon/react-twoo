...
var Fragment = require('./DistortionHoverFilter.frag');

var Vertext = require('./DistortionHoverFilter.vert');
/**
...
var DistortionHoverFilter = /*#__PURE__*/function (_PIXI$Filter) {
  _rollupPluginBabelHelpers.inherits(DistortionHoverFilter, _PIXI$Filter);

  var _super = _rollupPluginBabelHelpers.createSuper(DistortionHoverFilter);
  ...
  function DistortionHoverFilter(resolution) {
    ...
    _rollupPluginBabelHelpers.classCallCheck(this, DistortionHoverFilter);
  ...
  _rollupPluginBabelHelpers.createClass(DistortionHoverFilter, [{
    key: "apply",
...
module.exports = DistortionHoverFilter;
