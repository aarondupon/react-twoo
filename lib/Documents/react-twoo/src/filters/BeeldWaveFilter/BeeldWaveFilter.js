...
var BeeldWaveFilter = /*#__PURE__*/function (_PIXI$Filter) {
  _rollupPluginBabelHelpers.inherits(BeeldWaveFilter, _PIXI$Filter);

  var _super = _rollupPluginBabelHelpers.createSuper(BeeldWaveFilter);
  ...
  function BeeldWaveFilter() {
    ...
    _rollupPluginBabelHelpers.classCallCheck(this, BeeldWaveFilter);
  ...
  _rollupPluginBabelHelpers.createClass(BeeldWaveFilter, [{
    key: "apply",
...
module.exports = BeeldWaveFilter;
