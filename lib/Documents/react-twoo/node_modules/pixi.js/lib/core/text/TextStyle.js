...
var TextStyle_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var defaultStyle = {
  ...
  fill: 'black',
  fillGradientType: _const.__moduleExports.TEXT_GRADIENT.LINEAR_VERTICAL,
  fillGradientStops: [],
  fontFamily: 'Arial',
  fontSize: 26,
  fontStyle: 'normal',
...
function getSingleColor(color) {
  if (typeof color === 'number') {
    return (0, index.__moduleExports.hex2string)(color);
...
_commonjsHelpers.unwrapExports(TextStyle_1);

exports.__moduleExports = TextStyle_1;
