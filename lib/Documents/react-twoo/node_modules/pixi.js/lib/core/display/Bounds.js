...
var Bounds_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var Bounds = function () {
  ...
  Bounds.prototype.getRectangle = function getRectangle(rect) {
    if (this.minX > this.maxX || this.minY > this.maxY) {
      return index.__moduleExports.Rectangle.EMPTY;
    }

    rect = rect || new index.__moduleExports.Rectangle(0, 0, 1, 1);
    rect.x = this.minX;
    rect.y = this.minY;
...
_commonjsHelpers.unwrapExports(Bounds_1);

exports.__moduleExports = Bounds_1;
