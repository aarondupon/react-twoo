...
var RenderTarget_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var RenderTarget = function () {
  ...
  function RenderTarget(gl, width, height, scaleMode, resolution, root) {
    ...
    this.size = new index.__moduleExports.Rectangle(0, 0, 1, 1);
    /**
    ...
    this.projectionMatrix = new index.__moduleExports.Matrix();
    /**
    ...
    this.defaultFrame = new index.__moduleExports.Rectangle();
    ...
    if (!this.root) {
      this.frameBuffer = index$1['default'].GLFramebuffer.createRGBA(gl, 100, 100);

      if (this.scaleMode === _const.__moduleExports.SCALE_MODES.NEAREST) {
      ...
      this.frameBuffer = new index$1['default'].GLFramebuffer(gl, 100, 100);
...
_commonjsHelpers.unwrapExports(RenderTarget_1);

exports.__moduleExports = RenderTarget_1;
