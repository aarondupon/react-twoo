...
module.exports = function $$$reconciler($$$hostConfig) {
  ...
  function va(a) {
    if (null === a || "object" !== _rollupPluginBabelHelpers['typeof'](a)) { return null; }
  ...
  function wa(a) {
    ...
    if ("object" === _rollupPluginBabelHelpers['typeof'](a)) { switch (a.$$typeof) {
      case ka:
  ...
  function Tb(a, b) {
    ...
    try {
      if (b) {
        ...
        }), "object" === (typeof Reflect === "undefined" ? "undefined" : _rollupPluginBabelHelpers['typeof'](Reflect)) && Reflect.construct) {
          try {
            Reflect.construct(b, []);
          } catch (k) {
            var d = k;
  ...
  function Uc(a, b) {
    if (I(a, b)) { return !0; }
    if ("object" !== _rollupPluginBabelHelpers['typeof'](a) || null === a || "object" !== _rollupPluginBabelHelpers['typeof'](b) || null === b) { return !1; }
    var c = Object.keys(a),
        d = Object.keys(b);
  ...
  function wd(a, b, c) {
    var d = !1,
        e = Xb;
    var f = b.contextType;
    "object" === _rollupPluginBabelHelpers['typeof'](f) && null !== f ? f = J(f) : (e = E(b) ? Yb : B.current, d = b.contextTypes, f = (d = null !== d && void 0 !== d) ? Zb(a, e) : Xb);
    b = new b(c, f);
  ...
  function yd(a, b, c, d) {
    ...
    hd(a);
    var f = b.contextType;
    "object" === _rollupPluginBabelHelpers['typeof'](f) && null !== f ? e.context = J(f) : (f = E(b) ? Yb : B.current, e.context = Zb(a, f));
    nd(a, c, e, d);
    e.state = a.memoizedState;
  ...
  function Ad(a, b, c) {
    ...
    if (null !== a && "function" !== typeof a && "object" !== _rollupPluginBabelHelpers['typeof'](a)) {
      if (c._owner) {
        c = c._owner;
  ...
  function Cd(a) {
    ...
    function t(a, b, c) {
      ...
      if ("object" === _rollupPluginBabelHelpers['typeof'](b) && null !== b) {
        switch (b.$$typeof) {
          case da:
    ...
    function p(a, b, c, d) {
      ...
      if ("object" === _rollupPluginBabelHelpers['typeof'](c) && null !== c) {
        switch (c.$$typeof) {
          case da:
    ...
    function y(a, b, c, d, e) {
      ...
      if ("object" === _rollupPluginBabelHelpers['typeof'](d) && null !== d) {
        switch (d.$$typeof) {
          case da:
    ...
    return function (a, d, f, h) {
      var k = "object" === _rollupPluginBabelHelpers['typeof'](f) && null !== f && f.type === fa && null === f.key;
      k && (f = f.props.children);
      var l = "object" === _rollupPluginBabelHelpers['typeof'](f) && null !== f;
  ...
  function Ye(a, b, c, d, e) {
    ...
    if (null === b.stateNode) { null !== a && (a.alternate = null, b.alternate = null, b.flags |= 2), wd(b, c, d), yd(b, c, d, e), d = !0; }else if (null === a) {
      ...
      var k = g.context,
          l = c.contextType;
      "object" === _rollupPluginBabelHelpers['typeof'](l) && null !== l ? l = J(l) : (l = E(c) ? Yb : B.current, l = Zb(b, l));
      ...
      p = g.context;
      k = c.contextType;
      "object" === _rollupPluginBabelHelpers['typeof'](k) && null !== k ? k = J(k) : (k = E(c) ? Yb : B.current, k = Zb(b, k));
    ...
    do {
      ...
      try {
        ...
        a: {
          ...
          if (null !== k && "object" === _rollupPluginBabelHelpers['typeof'](k) && "function" === typeof k.then) {
            var l = k;
  ...
  fh = function fh(a, b, c) {
    ...
    switch (b.tag) {
      case 2:
        ...
        if ("object" === _rollupPluginBabelHelpers['typeof'](e) && null !== e && "function" === typeof e.render && void 0 === e.$$typeof) {
          b.tag = 1;
          b.memoizedState = null;
          b.updateQueue = null;
  ...
  function Fd(a, b, c, d, e, f) {
    ...
    if ("function" === typeof a) { Se(a) && (g = 1); }else if ("string" === typeof a) { g = 5; }else { a: switch (a) {
      ...
      default:
        if ("object" === _rollupPluginBabelHelpers['typeof'](a) && null !== a) { switch (a.$$typeof) {
          case ja:
            g = 10;
            break a;
        ...
        throw Error(q(130, null == a ? a : _rollupPluginBabelHelpers['typeof'](a), ""));
    } }
    b = Xd(g, c, b, e);
    b.elementType = a;
    b.type = d;
  ...
  exports.act = function (a) {
    ...
    if (null !== e && "object" === _rollupPluginBabelHelpers['typeof'](e) && "function" === typeof e.then) { return {
