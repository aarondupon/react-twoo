...
Framebuffer.prototype.enableTexture = function (texture) {
  var gl = this.gl;
  this.texture = texture || new GLTexture['default'](gl);
...
Framebuffer.createRGBA = function (gl, width, height, data) {
  var texture = GLTexture['default'].fromData(gl, null, width, height);
...
Framebuffer.createFloat32 = function (gl, width, height, data) {
  ...
  var texture = new GLTexture['default'].fromData(gl, data, width, height);
  texture.enableNearestScaling();
  texture.enableWrapClamp(); //now create the framebuffer object and attach the texture to it.
...
exports.__moduleExports = GLFramebuffer;
