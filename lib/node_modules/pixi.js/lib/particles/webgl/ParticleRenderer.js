...
var ParticleRenderer = function (_core$ObjectRenderer) {
  ...
  ParticleRenderer.prototype.render = function render(container) {
    ...
    this.shader.uniforms.tint = container._tintRGB; // make sure the texture is bound..

    var baseTexture = children[0]._texture.baseTexture;
    this.shader.uniforms.uSampler = renderer.bindTexture(baseTexture); // now lets upload and render the buffers..
