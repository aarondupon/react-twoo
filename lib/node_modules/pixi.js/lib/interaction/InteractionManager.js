...
var _typeof = typeof Symbol === "function" && _rollupPluginBabelHelpers['typeof'](Symbol.iterator) === "symbol" ? function (obj) {
  return _rollupPluginBabelHelpers['typeof'](obj);
} : function (obj) {
  return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : _rollupPluginBabelHelpers['typeof'](obj);
};
...
function _inherits(subClass, superClass) {
  if (typeof superClass !== "function" && superClass !== null) {
    throw new TypeError("Super expression must either be null or a function, not " + _rollupPluginBabelHelpers['typeof'](superClass));
  }
...
var InteractionManager = function (_EventEmitter) {
  ...
  InteractionManager.prototype.processInteractive = function processInteractive(interactionEvent, displayObject, func, hitTest, interactive) {
    ...
    var hit = false;
    var interactiveParent = interactive; // if the displayobject has a hitArea, then it does not need to hitTest children.
