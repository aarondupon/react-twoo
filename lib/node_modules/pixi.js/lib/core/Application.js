...
var index = require('./ticker/index.js');

var Application_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var _Container2 = _interopRequireDefault(Container);
...
var Application = function () {
  ...
  function Application(options, arg2, arg3, arg4, arg5) {
    _classCallCheck(this, Application); // Support for constructor(width, height, options, noWebGL, useSharedTicker)
    ...
    this.renderer = (0, autoDetectRenderer.__moduleExports.autoDetectRenderer)(options);
    /**
    ...
    this.ticker = options.sharedTicker ? index.__moduleExports.shared : new index.__moduleExports.Ticker(); // Start the rendering
  ...
  _createClass(Application, [{
    ...
    set: function set(ticker) // eslint-disable-line require-jsdoc
    {
      ...
      if (ticker) {
        ticker.add(this.render, this, _const.__moduleExports.UPDATE_PRIORITY.LOW);
      }
    },
...
_commonjsHelpers.unwrapExports(Application_1);

exports.__moduleExports = Application_1;
