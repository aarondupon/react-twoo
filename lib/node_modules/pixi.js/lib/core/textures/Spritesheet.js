...
var Spritesheet_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var Spritesheet = function () {
  ...
  Spritesheet.prototype._updateResolution = function _updateResolution(resolutionFilename) {
    ...
    var resolution = (0, index.__moduleExports.getResolutionOfUrl)(resolutionFilename, null); // No resolution found via URL
  ...
  Spritesheet.prototype._processFrames = function _processFrames(initialFrameIndex) {
    ...
    while (frameIndex - initialFrameIndex < maxFrames && frameIndex < this._frameKeys.length) {
      ...
      if (rect) {
        var frame = null;
        var trim = null;
        var orig = new index$1.__moduleExports.Rectangle(0, 0, this._frames[i].sourceSize.w / this.resolution, this._frames[i].sourceSize.h / this.resolution);

        if (this._frames[i].rotated) {
          frame = new index$1.__moduleExports.Rectangle(rect.x / this.resolution, rect.y / this.resolution, rect.h / this.resolution, rect.w / this.resolution);
        } else {
          frame = new index$1.__moduleExports.Rectangle(rect.x / this.resolution, rect.y / this.resolution, rect.w / this.resolution, rect.h / this.resolution);
        } //  Check to see if the sprite is trimmed


        if (this._frames[i].trimmed) {
          trim = new index$1.__moduleExports.Rectangle(this._frames[i].spriteSourceSize.x / this.resolution, this._frames[i].spriteSourceSize.y / this.resolution, rect.w / this.resolution, rect.h / this.resolution);
        }

        this.textures[i] = new index$1.__moduleExports.Texture(this.baseTexture, frame, orig, trim, this._frames[i].rotated ? 2 : 0); // lets also add the frame to pixi's global cache for fromFrame and fromImage functions

        index$1.__moduleExports.Texture.addToCache(this.textures[i], i);
      }
...
_commonjsHelpers.unwrapExports(Spritesheet_1);

exports.__moduleExports = Spritesheet_1;
