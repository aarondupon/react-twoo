...
var extractUniformsFromSrc = require('./extractUniformsFromSrc.js');
...
var _extractUniformsFromSrc2 = _interopRequireDefault(extractUniformsFromSrc.__moduleExports);
...
var Filter = function () {
  ...
  function Filter(vertexSrc, fragmentSrc, uniforms) {
    ...
    this.blendMode = _const.__moduleExports.BLEND_MODES.NORMAL;
    ...
    if (!SOURCE_KEY_MAP[this.vertexSrc + this.fragmentSrc]) {
      SOURCE_KEY_MAP[this.vertexSrc + this.fragmentSrc] = (0, index.__moduleExports.uid)();
    }
...
_commonjsHelpers.unwrapExports(Filter_1);

exports.__moduleExports = Filter_1;
