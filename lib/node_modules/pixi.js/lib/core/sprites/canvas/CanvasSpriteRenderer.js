...
var CanvasTinter = require('./CanvasTinter.js');

var CanvasSpriteRenderer_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var _CanvasTinter2 = _interopRequireDefault(CanvasTinter.__moduleExports);
...
var canvasRenderWorldTransform = new index.__moduleExports.Matrix();
/**
 * @author Mat Groves
 *
...
var CanvasSpriteRenderer = function () {
  ...
  CanvasSpriteRenderer.prototype.render = function render(sprite) {
    ...
    if (texture.valid) {
      ...
      var smoothingEnabled = texture.baseTexture.scaleMode === _const.__moduleExports.SCALE_MODES.LINEAR;
      ...
      if (texture.rotate) {
        ...
        index.__moduleExports.GroupD8.matrixAppendRotationInv(wt, texture.rotate, dx, dy); // the anchor has already been applied above, so lets set it to zero
...
_commonjsHelpers.unwrapExports(CanvasSpriteRenderer_1);

exports.__moduleExports = CanvasSpriteRenderer_1;
