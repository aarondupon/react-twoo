...
var canUseNewCanvasBlendModes = require('../../renderers/canvas/utils/canUseNewCanvasBlendModes.js');

var CanvasTinter_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var _canUseNewCanvasBlendModes2 = _interopRequireDefault(canUseNewCanvasBlendModes.__moduleExports);
...
var CanvasTinter = {
  ...
  tintWithPerPixel: function tintWithPerPixel(texture, color, canvas) {
    ...
    context.globalCompositeOperation = 'copy';
    context.drawImage(texture.baseTexture.source, crop.x, crop.y, crop.width, crop.height, 0, 0, crop.width, crop.height);
    var rgbValues = (0, index.__moduleExports.hex2rgb)(color);
    var r = rgbValues[0];
    var g = rgbValues[1];
    var b = rgbValues[2];
  ...
  roundColor: function roundColor(color) {
    ...
    return (0, index.__moduleExports.rgb2hex)(rgbValues);
  },
...
_commonjsHelpers.unwrapExports(CanvasTinter_1);

exports.__moduleExports = CanvasTinter_1;
