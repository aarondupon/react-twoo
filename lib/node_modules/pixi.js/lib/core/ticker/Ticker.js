...
var Ticker_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var _TickerListener2 = _interopRequireDefault(TickerListener.__moduleExports);
...
var Ticker = function () {
  ...
  Ticker.prototype.add = function add(fn, context) {
    var priority = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _const.__moduleExports.UPDATE_PRIORITY.NORMAL;
  ...
  Ticker.prototype.update = function update() {
    ...
    var elapsedMS = void 0; // If the difference in time is zero or negative, we ignore most of the work done here.
    ...
    if (currentTime > this.lastTime) {
      ...
      this.deltaTime = elapsedMS * _settings2["default"].TARGET_FPMS * this.speed; // Cache a local reference, in-case ticker is destroyed
...
_commonjsHelpers.unwrapExports(Ticker_1);

exports.__moduleExports = Ticker_1;
