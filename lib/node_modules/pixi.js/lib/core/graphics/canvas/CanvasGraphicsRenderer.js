...
var CanvasGraphicsRenderer_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var CanvasGraphicsRenderer = function () {
  ...
  CanvasGraphicsRenderer.prototype.render = function render(graphics) {
    ...
    var resolution = renderer.resolution; // if the tint has changed, set the graphics object to dirty.
    ...
    for (var i = 0; i < graphics.graphicsData.length; i++) {
      ...
      if (data.type === _const.__moduleExports.SHAPES.POLY) {
        context.beginPath();
      ...
      } else if (data.type === _const.__moduleExports.SHAPES.RECT) {
      ...
      } else if (data.type === _const.__moduleExports.SHAPES.CIRC) {
      ...
      } else if (data.type === _const.__moduleExports.SHAPES.ELIP) {
      ...
      } else if (data.type === _const.__moduleExports.SHAPES.RREC) {
        var rx = shape.x;
        var ry = shape.y;
  ...
  CanvasGraphicsRenderer.prototype.updateGraphicsTint = function updateGraphicsTint(graphics) {
    ...
    for (var i = 0; i < graphics.graphicsData.length; ++i) {
      ...
      var lineColor = data.lineColor | 0; // super inline cos im an optimization NAZI :)
...
_commonjsHelpers.unwrapExports(CanvasGraphicsRenderer_1);

exports.__moduleExports = CanvasGraphicsRenderer_1;
