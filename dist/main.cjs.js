...
var animate = require('animate'); // import TextureLoader from './../core/TextureLoader';
/**
 *
...
var BeeldSliderFilter$1 = /*#__PURE__*/function (_PIXI$Filter) {
  ...
  function BeeldSliderFilter() {
    ...
    _this.animation = animate__default['default'](_this.update, 24);
    _this.animate = true;
    return _this;
  }
  /**
