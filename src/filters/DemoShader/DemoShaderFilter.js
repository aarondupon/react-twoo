...
var Fragment = require('./DemoShader.frag');
var Vertext = require('./DemoShader.vert');

/**
 * The DemoShaderFilter applies a Gaussian blur to an object.
 ...
 */
export default class DemoShaderFilter extends PIXI.Filter
{
    /**
     * Creates an instance of DemoShaderFilter.
     * @param {*} speed
     * @param {*} resolution
     * @memberof DemoShaderFilter
     */
