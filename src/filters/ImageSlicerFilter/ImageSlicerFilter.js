...
var Fragment = require('./ImageSlicerFilter.frag');
var Vertext = require('./ImageSlicerFilter.vert');

/**
 * The ImageSlicerFilter applies a Gaussian blur to an object.
 ...
 */
export default class ImageSlicerFilter extends PIXI.Filter
{
    /**
     * Creates an instance of ImageSlicerFilter.
     * @param {*} speed
     * @param {*} resolution
     * @memberof ImageSlicerFilter
     */
    constructor(speed = 1 ,resolution)
    {
