...
export default class AccessibilityManager
{
    ...
    activate()
    {
        ...
        if (this.renderer.view.parentNode && !this.__added)
        {
            ...
            var oldDiv = document.querySelectorAll(`[data-htmlrenderer-target-name='${this.renderer.view.getAttribute('data-name')}']`)[0];
            //document.querySelectorAll( 'data-htmlrenderer-target-name',this.renderer.view.getAttribute('data-name'))[0]
    ...
    update()
    {
        ...
        if(!fpsController.checkfps(12))  return
      //  console.log('update:HTMLRENDER')
        // update children...
        ...
        for (let i = 0; i < this.children.length; i++)
        {
            ...
            else
            {
               ...
               //S     div.style.background = 'rgba(0,0,255,.2)';
